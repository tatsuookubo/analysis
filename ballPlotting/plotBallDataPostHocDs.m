function plotBallDataPostHocDs(prefixCode,expNum,flyNum,flyExpNum)
...
for i = 1:length(uniqueStim)
    ...
    h(2) = subplot(7,2,3);
    hold on
    mySimplePlot(groupedData.dsTime,mean(groupedData.xVel(stimNumInd,:)),'Color',colorSet(i,:))
    set(gca,'XTick',[])
    ...
    h(3) = subplot(7,2,5);
    hold on
    mySimplePlot(groupedData.dsTime,mean(groupedData.yVel(stimNumInd,:)),'Color',colorSet(i,:))
    set(gca,'XTick',[])
    ...
    h(4) = subplot(7,2,7);
    hold on
    mySimplePlot(groupedData.dsTime,mean(groupedData.xDisp(stimNumInd,:)),'Color',colorSet(i,:))
%     shadedErrorBar(groupedData.dsTime,mean(groupedData.xDisp(stimNumInd,:)),std(groupedData.xDisp(stimNumInd,:)))
    ...
    h(5) = subplot(7,2,9);
    hold on
    mySimplePlot(groupedData.dsTime,mean(groupedData.yDisp(stimNumInd,:)),'Color',colorSet(i,:))
    ylabel({'Y Disp';'(mm)'})
    set(get(gca,'YLabel'),'Rotation',0,'HorizontalAlignment','right')
